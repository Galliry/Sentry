...
void PID_Init(void)
{
    ...
    BasePID_Init(&pid_pitch_angle, 0.48, 0.005f, -0.005, 1.5); // 云台
    BasePID_Init(&pid_pitch_speed, 0.60, 0, 3, 0);
    BasePID_Init(&pid_yaw_s_angle, 1.1, 0.0045, 3.2, 2);//1.9 -2.5
    BasePID_Init(&pid_yaw_s_speed, 2400, 0, 0, 2); // 2400

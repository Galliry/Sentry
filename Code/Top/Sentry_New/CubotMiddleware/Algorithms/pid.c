...
void PID_Init(void)
{
    ...
    BasePID_Init(&pid_pitch_angle, 0.5, 0.005f, -0.005, 1.5); // 云台 0.45 0.005 -0.005 1.5
    BasePID_Init(&pid_pitch_speed, 0.55, 0, 3, 0);
    BasePID_Init(&pid_yaw_s_angle, 1.2, 0.0045, -4, 2);//0.8 0.0045 -4 打符PID
    BasePID_Init(&pid_yaw_s_speed, 2200, 0, 0, 2); // 2200

...
void RobotOnlineState(Check_Robot_State* CheckRobotState,RC_Ctrl_ET* rc_ctrl,RC_Ctrl* rc_ctrl_dr16)
{
	...
	Receive.Top.Online_check.StatusCnt++;
	Receive.Top.Online_check.StatusCnt = int16_constrain(Receive.Top.Online_check.StatusCnt,0,200);
	if(Receive.Top.Online_check.StatusCnt < 30){Receive.Top.Online_check.Status = 1;}else{Receive.Top.Online_check.Status = 0;}

...
// 需手动校准，修改数据
#define BMI088_GxOFFSET (0.00159967167f)//(-0.00418030564f)
#define BMI088_GyOFFSET (0.000630281691f)//(-0.0052329856f)
#define BMI088_GzOFFSET (0.00278744334f)//(-0.000287621311f)
#define BMI088_gNORM     9.77522469f//10.2522392f
 ...
 */
extern uint8_t BMI088_Init(struct _IMU_InitData_t *);
